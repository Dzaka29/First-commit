void main(List<String> args) {
   ...
   * yang mana jika sudah mencapai hasil yang sudah diinginkan makan
...
// (variable; kondisi ; increment/decrement)
   ...
   * ! = 'not' kebalikan jika true makan hasilnya false 
   * - = pengurangan
   * + = penjumlahan
   * / = pembagian
   * * = perkalian
   ...
   * kemudian bari di decrement (-1)
   * 10-1, ,aka 9 lebih dari 0 print hasil 9
   * 9-1, maka 8 lebih dari 0 print berhasil 8, dan seterusnya 
  ...
  // perulangan bersarang ( nesed loop )
  ...
  for (var i = 1; i <= 10; i++) {
    ...
    /**
     * variable j itu harus
     * sama dengan variable i
     * kenapa?
